...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (BOOL)getObjectValue:(id _Nullable * _Null_unspecified)obj forString:(NSString * _Nonnull)string errorDescription:(NSString * _Nullable * _Null_unspecified)error;
...
@property (nonatomic, strong) NavigationAccessoryView * _Nonnull navigationAccessoryView;
...
@property (nonatomic, copy) void (^ _Nullable completionCallback)(UIViewController * _Nonnull);
- (void)viewDidLoad;
